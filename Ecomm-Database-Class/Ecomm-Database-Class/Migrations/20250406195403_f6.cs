...
namespace Ecomm_Database_Class.Migrations
{
    ...
    public partial class f6 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Brand", "CategoryId", "CategoryId1", "Description", "ImageUrl", "Name", "Price", "Quantity", "SoldCount", "SubCategoryId", "SubCategoryId1" },
                values: new object[,]
                {
                    { 1, "Omega", 1, null, "Luxury dive watch", "", "Omega Seamaster", 2999.99m, 0, 120, 1, null },
                    { 2, "Casio", 2, null, "Rugged digital watch", "", "Casio G-Shock", 149.99m, 0, 500, 2, null }
                });
